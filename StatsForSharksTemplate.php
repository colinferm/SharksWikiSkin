...
class StatsForSharksTemplate extends BaseTemplate {
		...
		<div class="title-bar" data-sticky data-options="marginTop:0;" style="width:100%">
			...
			<div class="title-bar-right">
					<ul class="menu float-right hide-for-small-only">
						...
						<button type="button" class="button" name="go" value="go"  style="display: inline-block;">Search</button>
	...
	<div class="row main-content-well">
		...
		<div class="medium-2 columns hide-for-small-only editcolumn">
	...
	<script type="text/javascript">
		RLQ.push(function() {
			console.log("pushed");
			//mw.loader.using(["mediawiki.base"]).done(function() {
				console.log("test");
				var $ = jQuery;
